...
Build the pricing section with 3 tiers. The 3-tier model is proven: the middle tier is the target, the lower tier makes the middle look reasonable, the upper tier captures ambitious buyers. Default to 3-tier fixed fee unless the user specifies otherwise.
...
- Geographic market
- The firm's positioning and reputation
