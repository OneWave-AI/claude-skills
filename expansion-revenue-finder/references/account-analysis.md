# Account Analysis Reference

## Account expansion profile template
...
## Benchmark against segments

Compare each account against its peer group to identify under-penetration:
...
If no benchmark data exists, build relative benchmarks from the portfolio itself: the top quartile of existing customers becomes the benchmark for everyone else.
